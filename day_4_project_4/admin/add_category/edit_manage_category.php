...
$ID=$_GET['id'];
$result=$test=add_category_function::edit_category($ID);
$viewResult=mysqli_fetch_assoc($result);
if(isset($_POST['btn'])){
    $fun=add_category_function::update_category($_POST,$ID);
}
         ...
         <div class="row">
             <div class="col-sm-8 offset-sm-2 bg-light mt-5">
                 ...
                 <form action="" method="post">
                     <h2 class="text-center text-danger"><?php  ?></h2>
                     <div class="form-group">
                         ...
                         <input type="text" required name="add_catagory" class="form-control"
                             ...
                             value="<?php echo $viewResult['add_catagory'] ?>">
                     </div>
                     <div class="form-group">
                         <label for="exampleFormControlSelect1">Puplication status</label>
                         <select class="form-control" value="" name="publication_status" required
                             name="publication_status" id="exampleFormControlSelect1">
                     ...
                     <div class="form-group">
                         ...
                         <textarea class="form-control" name="blog_description" id="exampleFormControlTextarea1"
                             rows="3" value=""><?php echo $viewResult['blog_description'] ?></textarea>
                     </div>
                     <div class="form-control">
                         <input type="submit" name="btn" value="Update " id="update_success" class="btn-block btn-info">
                     </div>
                 </form>
             </div>
         </div>
