...
$result=$test= Blog_function::tray_category();
...
<head>
    ...
    <link href="assest/front/css/heroic-features.css" rel="stylesheet">
...
<body>
        ...
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100">
                    <img class="card-img-top" src="admin/<?php echo $viewResult['blog_image']; ?>" alt="">
                    <div class="card-body">
                        <h4 class="card-title">
                            <?PHP echo $viewResult['blog_title']; ?>
                        </h4>
    ...
    <script src="assest/front/js/jquery.min.js"></script>
    <script src="assest/front/js/bootstrap.bundle.min.js"></script>
