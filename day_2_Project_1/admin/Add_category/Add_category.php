...
session_start();
use app\Save_add_category;

$message='';
if (isset($_POST['btn'])){
    $message= $test= Save_add_category::save_add_category_from($_POST);
}
?>
        ...
        <div class="col-sm-8 offset-sm-2 bg-light mt-5">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="add_catagory" class="form-control" id="exampleFormControlInput1" placeholder="catagory Name">
                </div>
                <div class="form-group">
