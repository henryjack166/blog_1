...
<div class="article">
    ...
    <div class="clr"></div>
    <div class="img"><img src="{{asset('/frontsss/')}}/images/img1.jpg" width="177" height="213" alt="" class="fl" />
    </div>
    <div class="post_content">
        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec libero. <a href="#">Suspendisse bibendum.
                Cras id urna.</a> Morbi tincidunt, orci ac convallis
...
<div class="article">
    ...
    <div class="clr"></div>
    <div class="img"><img src="{{asset('/frontsss/')}}/images/img2.jpg" width="177" height="213" alt="" class="fl" />
    </div>
    <div class="post_content">
